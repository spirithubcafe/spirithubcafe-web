                      ...
                      <div className="space-y-4">
                        ...
                        <div className="space-y-2">
                          ...
                          <Input
                            ...
                            value={selectedSlide.typography?.title_font_family || ''}
                        ...
                        <div className="space-y-2">
                          ...
                          <Input
                            id="title-font-size"
                            value={selectedSlide.typography?.title_font_size || ''}
                            onChange={(e) => updateSlide(selectedSlide.id, {
                              typography: {
                                ...selectedSlide.typography,
                        ...
                        <div className="space-y-2">
                          ...
                          <Select
                            value={selectedSlide.typography?.title_font_weight?.toString() || '700'}
                        ...
                        <div className="space-y-2">
                          ...
                          <Input
                            id="title-color"
                            type="color"
                            value={selectedSlide.typography?.title_color || '#ffffff'}
                            onChange={(e) => updateSlide(selectedSlide.id, {
                              typography: {
                                ...selectedSlide.typography,
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="space-y-2">
                          ...
                          <Input
                            ...
                            value={selectedSlide.typography?.title_font_family_ar || ''}
                            onChange={(e) => updateSlide(selectedSlide.id, {
                              typography: {
                                ...selectedSlide.typography,
                        ...
                        <div className="space-y-2">
                          ...
                          <Input
                            ...
                            value={selectedSlide.typography?.title_font_size_ar || ''}
                            onChange={(e) => updateSlide(selectedSlide.id, {
                              typography: {
                                ...selectedSlide.typography,
                        ...
                        <div className="space-y-2">
                          ...
                          <Select
                            value={selectedSlide.typography?.title_font_weight_ar?.toString() || '700'}
                            onValueChange={(value) => updateSlide(selectedSlide.id, {
                              typography: {
                                ...selectedSlide.typography,
                        ...
                        <div className="space-y-2">
                          ...
                          <Input
                            id="title-color-ar"
                            type="color"
                            value={selectedSlide.typography?.title_color_ar || '#ffffff'}
                            onChange={(e) => updateSlide(selectedSlide.id, {
                              typography: {
                                ...selectedSlide.typography,
