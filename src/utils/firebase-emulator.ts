...
// Note: Firestore Lite doesn't support emulator connection the same way
  ...
  if (import.meta.env.DEV) {
    try {
      ...
      if (useEmulators) {
        ...
        // Note: Firestore Lite doesn't support emulator connections
        // Firestore emulator connection is disabled when using Lite version
        console.log('📝 Using Firestore Lite - emulator connections not supported');
