 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ho="storage";function jf(n,e,t){return n=k(n),pf(n,e,t)}function qf(n){return n=k(n),mf(n)}function Hf(n){return n=k(n),gf(n)}function zf(n,e){return n=k(n),If(n,e)}function Wf(n=ur(),e){n=k(n);const r=ln(n,Ho).getImmediate({identifier:e}),s=Ks("storage");return s&&Tf(r,...s),r}function Tf(n,e,t,r={}){Ef(n,e,t,r)}function bf(n,{instanceIdentifier:e}){const t=n.getProvider("app").getImmediate(),r=n.getProvider("auth-internal"),s=n.getProvider("app-check-internal");return new Mr(t,r,s,e,Je)}function vf(){je(new Ne(Ho,bf,"PUBLIC").setMultipleInstances(!0)),ue(js,qs,""),ue(js,qs,"esm2020")}vf();export{Vf as A,Au as B,Ne as C,Su as D,vt as E,pe as F,Ou as G,Pu as H,Vu as I,Ru as J,Cu as K,ar as L,Mf as M,zf as N,Hf as O,jf as P,qf as Q,Sf as R,je as _,ln as a,aa as b,Rf as c,ur as d,$e as e,Af as f,k as g,yc as h,sa as i,jl as j,Wf as k,kf as l,rd as m,Lf as n,Ua as o,Cf as p,Of as q,ue as r,Uf as s,Ff as t,xf as u,ca as v,Nf as w,Bf as x,$f as y,Df as z};
